...
ZSH_THEME_RANDOM_CANDIDATES=( "agnoster" "gallois" "af-magic" )
...
plugins=(
  git git-extras gitfast git-prompt aws chucknorris command-not-found docker dircycle virtualenv magic-enter vault pyenv
)
